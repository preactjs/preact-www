...
如果你想直接深入，可以前往我们的 [文档](/guide/v11/signals) 深入了解 signals。
...
然而，这种情况让我们无法忽视。我们能做些什么来实现这种清晰的模型呢？我们开始使用 Preact 的 [可插拔渲染器](/guide/v11/options) 原型化各种想法和实现。虽然花了一些时间，但我们最终找到了一种方法：
...
如果你感到好奇并想立即尝试，可以前往我们的[文档](/guide/v11/signals)查看有关 signals 的内容。我们很想听听你将如何使用它们。
