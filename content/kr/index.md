...
<jumbotron>
    ...
    <p class="intro-buttons">
        <a href="/guide/v11/getting-started" class="btn primary">시작하기</a>
        <a href="/guide/v11/getting-started#aliasing-react-to-preact" class="btn secondary">Preact로 전환하기</a>
    </p>
</jumbotron>
...
<section class="home-section">
  ...
  <div>
    ...
    <p>
      간단한 <a href="/guide/v11/getting-started#aliasing-react-to-preact">preact/compat</a> 별칭을 번들러에 추가하면 가장 복잡한 React 구성 요소도 애플리케이션에서 사용할 수 있는 호환성 계층이 제공됩니다.
    </p>
  </div>
</section>
