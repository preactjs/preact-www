...
<jumbotron>
    ...
    <p class="intro-buttons">
        <a href="/guide/v11/getting-started" class="btn primary">Commencer</a>
        <a href="/guide/v11/getting-started#aliasing-react-to-preact" class="btn secondary">Passer à preact</a>
    </p>
</jumbotron>
...
<section class="home-section">
  <div>
    ...
    <p>
        Un simple alias vers <a href="/guide/v11/getting-started#aliasing-react-to-preact">preact-compat</a> apporte une couche de compatibilité qui permet l'utilisation des fonctionnalités les plus complexes de React.
    </p>
  </div>
</section>
