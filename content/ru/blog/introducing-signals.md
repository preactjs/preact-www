...
Если вы хотите сразу приступить к работе, перейдите к нашей [документации](/guide/v11/signals), чтобы получить более подробную информацию о сигналах.
...
Если вам интересно и вы хотите сразу приступить к делу, перейдите к нашей [документации](/guide/v11/signals). Нам бы хотелось узнать, как вы собираетесь их использовать.
