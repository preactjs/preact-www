...
Сигналы — это подход команды Preact к реактивному программированию. Если вы хотите получить краткое представление о том, что такое _сигналы_ и как они связаны с Preact, вам поможет [сообщение в блоге с анонсом Signals](/blog/introducing-signals). Для более глубокого погружения ознакомьтесь с [официальной документацией](/guide/v11/signals).
...
Существуют и другие функции, например [`batch`](/guide/v11/signals/#batchfn), но эти три являются наиболее значимыми для последующих замечаний по внедрению.
