...
[Fragment docs →](/guide/v11/components#fragments)
...
[Lifecycle docs →](/guide/v11/components#error-boundaries)
...
[createContext Docs →](/guide/v11/context#createcontext)
...
The compatibility layer is now called [preact/compat](/guide/v11/differences-to-react#features-exclusive-to-preactcompat), and has learned several new tricks such as `forwardRef`, `memo` and countless compatibility improvements.
