...
Signals are the Preact team's take on reactive programming. If you want a gentle introduction on what Signals are all about and how they tie in with Preact, [the Signals announcement blog post](/blog/introducing-signals) has got you covered. For a deeper dive check out the [official documentation](/guide/v11/signals).
...
There are other functions, like [`batch`](/guide/v11/signals/#batchfn), but these three are the most relevant to the implementation notes that follow.
