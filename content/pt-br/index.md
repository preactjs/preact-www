...
<jumbotron>
    ...
    <p class="intro-buttons">
        <a href="/guide/v11/getting-started" class="btn primary">Como começar</a>
        <a href="/guide/v11/getting-started#aliasing-react-to-preact" class="btn secondary">Mudando para Preact</a>
    </p>
</jumbotron>
...
<section class="home-section">
  ...
  <div>
    ...
    <p>
        Ao adicionar um simples <i>alias</i> <a href="/guide/v11/getting-started#aliasing-react-to-preact">preact-compat</a> ao seu <i>bundler</i> adiciona uma camada de compatibilidade que possibilita até mesmo os componentes React mais complexos a serem utilizados na sua aplicação.
    </p>
  </div>
</section>
